  ...
  return (
    <Screen>
      ...
      <Card>
        ...
        <Line
          label="Groq key"
          value={settings.groqApiKey ? maskSecret(settings.groqApiKey) : 'not set'}
        />
        <Line
          label="NVIDIA key"
          value={settings.nvidiaApiKey ? maskSecret(settings.nvidiaApiKey) : 'not set'}
        />
      ...
      <Text style={{color: theme.colors.faint, marginTop: 12}}>
        Full API keys are never shown here.
      </Text>
    </Screen>
  );
}
